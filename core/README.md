...
* [LDAP-specific subschemas](./alter-external-domain-input-anyof-ldap-specific-subschemas.md) – `http://schema.nethserver.org/cluster/alter-external-domain-input.json#/anyOf/1`
...
* [Protocol property is ldap](./alter-external-domain-input-anyof-0-protocol-property-is-ldap.md) – `http://schema.nethserver.org/cluster/alter-external-domain-input.json#/anyOf/0/not`
...
* [TCP service endpoint](./alter-external-domain-input-defs-tcp-service-endpoint.md "Initial TCP backend endpoint configuration") – `http://schema.nethserver.org/cluster/alter-external-domain-input.json#/$defs/tcp-service-endpoint`
